...
summary: "Multi-agent, local-first AI assistant that takes your CV and a job description (text), then: Analyzes how well your CV matches the role, Checks basic ATS readiness, Rewrites key sections (Summary, Skills, Experience bullets), Explains why each change helps for this specific job"
